...
const BUILTIN_DATA = [
  ...
  {company:"Orbital Astronautics",country:"England",platform:"Microsat",platformMass:"95 kg",payloadPower:"Up to 2 kW peak; up to 500 W avg",payloadMass:"Up to 100 kg",orbit:"LEO",lifetime:"6 years",pointingAcc:"0.01 deg",pointingKnowledge:"0.001 deg",pointingControl:"3-axis stabilized",propulsion:"Propulsion configuration available",dataInterface:"Standard bus/payload interfaces (ICD pg 32-39)",downlink:"S-band (satellite also operates in S Band)",tcTm:"S-band TT&C omni up to 20 Mbps; 16,000 TM/TC channels",powerVoltage:"29.6 V nominal (25.2-33 V) regulated",solarArray:"Deployable solar wing option",rideshare:"15-inch interface; compatible with SpaceX, PSLV",heritage:"12 satellite missions; 21 OBC; 45 reaction wheels; 19 star trackers; 16 thrusters",remarks:"OrbAstro Microsat per ICD OA-ICD-ORB-M-01-1.2; 350 W payload thermal @ 35C interface"},
...
function normalizeBusKeys(obj) {
  const fieldMap = {
    ...
    "pointingacc": "pointingAcc",
    "pointing stability": "pointingStability",
    "pointingstability": "pointingStability",
    "pointing knowledge": "pointingKnowledge",
    "pointingknowledge": "pointingKnowledge",
    ...
    "downlink": "downlink", "tc/tm": "tcTm", "tctm": "tcTm",
